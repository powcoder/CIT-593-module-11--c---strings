...
def convert_notebook(infile, outfile_arg):
    print('======================================================================')
    print(' > Beginning conversion of {}'.format(infile))
    f = open(infile)
    contents = f.read()
    f.close()
    ...
    print(' > Wrote {} function definition cells'.format(definitions))
    print(' > Wrote {} declarative cells'.format(declarations))
    print('======================================================================')
    print(' > Finished writing to {}'.format(outfile_arg))
    print('======================================================================')
